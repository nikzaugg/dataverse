...
public class FileUtilTest {
    ...
    @ParameterizedTest
        @MethodSource("inputsForTestGetCiteDataFileFilename")
    public void testGetCiteDataFileFilename(String expectedFileName, String actualFileName, FileCitationExtension citationExtension) {
        assertEquals(expectedFileName, FileUtil.getCiteDataFileFilename(actualFileName, citationExtension));
    }

    // arguments for parameterized test - testGetCiteDataFileFilename
    private static Stream<Arguments> inputsForTestGetCiteDataFileFilename() {
        return Stream.of(
    ...
    @ParameterizedTest
    @MethodSource("inputsForTestReplaceExtension")
    public void testReplaceExtension(String expectedString, String originalName, String newExtension) {
        assertEquals(expectedString, FileUtil.replaceExtension(originalName, newExtension));
    }

    // arguments for parameterized test - testReplaceExtension
    private static Stream<Arguments> inputsForTestReplaceExtension() {
        return Stream.of(
